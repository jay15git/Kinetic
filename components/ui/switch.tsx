        ...
        <SwitchPrimitive.Root
          ...
          style={{
            ...
            backgroundColor: checked
              ? hovered
                ? "var(--switch-checked-hover, var(--focus-ring-hover))"
                : "var(--switch-checked, var(--focus-ring))"
              : hovered
                ? "var(--accent-hover)"
                : "var(--accent)",
          }}
          ...
          <SwitchPrimitive.Thumb
            render={(props) => {
              ...
              return (
                <motion.span
                  {...rest}
                  className="absolute top-0 left-0 block rounded-full bg-background shadow-sm"
                  initial={false}
                  style={{
