...
const Slider = forwardRef<HTMLDivElement, SliderProps>(
  (
    ...
    const compact = !showValue;
    const trackHitHeight = compact ? THUMB_SIZE : THUMB_SIZE + 16;
    const trackTopRest = compact
      ? (THUMB_SIZE - TRACK_HEIGHT) / 2
      : 8 + (THUMB_SIZE - TRACK_HEIGHT) / 2;
    const trackTopHover = compact
      ? (THUMB_SIZE - 8) / 2
      : 8 + (THUMB_SIZE - 8) / 2;
    const tooltipPad = showValue && valuePosition === "tooltip" ? 16 : 0;
    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{
            height: THUMB_SIZE + tooltipPad,
            paddingTop: tooltipPad,
          }}
        ...
        >
          ...
          >
            ...
            <AnimatePresence>
              {showValue && hoverPreview && valuePosition !== "tooltip" && (
                <HoverPreviewTooltip
                  key="hover-tip"
            ...
            <motion.div
              ...
              animate={{
                ...
                top: isHovered || isPressed ? trackTopHover : trackTopRest,
              }}
              transition={springs.fast}
            ...
            >
              <motion.div
                ...
                style={{
                  left: fillLeft,
                  width: fillWidth,
                  backgroundColor: "var(--landing-ink-3, #a1a1aa)",
                }}
              />
