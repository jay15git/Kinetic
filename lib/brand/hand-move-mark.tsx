const HAND_MOVE_PATHS = [
  ...
  "M2.541 5.594a13.487 13.487 0 0 1 2.46 -1.427",
  "M14 3.458c1.32 .354 2.558 .902 3.685 1.612",
] as const

type HandMoveMarkProps = {
  stroke: string
  size: number
}

export function HandMoveMark({ stroke, size }: HandMoveMarkProps) {
  return (
    <svg
